(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "nav.try": "Try now",
      "hero.line1": "Oneweek a planner",
      "hero.line2": "for a world in flux",
      ...
      "features.1.lead": "Custom themes",
      "features.1.rest":
        " — your own text color, background, and font for the mood or task at hand.",
      "features.2.lead": "Time-anchored tasks",
      "features.2.rest":
        " — pin something to a moment during the week so it doesn't get lost in the flow.",
      "features.3.lead": "Shared task inbox",
      "features.3.rest":
        " — tasks without a specific day that you can drag into any date when the time comes.",
      "features.4.lead": "Color coding",
      "features.4.rest":
        " — highlight what matters most so it stands out at a glance.",
    ...
    ru: {
      ...
      "nav.try": "Попробовать",
      "hero.line1": "Oneweek\u00A0— планер",
      "hero.line2": "для\u00A0мира, который не\u00A0стоит на\u00A0месте",
      ...
      "features.1.lead": "Кастомные темы",
      "features.1.rest":
        "\u00A0— свой цвет текста, фона и\u00A0шрифт под\u00A0настроение или задачу.",
      "features.2.lead": "Задачи по\u00A0времени",
      "features.2.rest":
        "\u00A0— привяжите дело к\u00A0моменту в\u00A0течение недели, чтобы оно не\u00A0потерялось в\u00A0общем потоке.",
      "features.3.lead": "Общая корзина дел",
      "features.3.rest":
        "\u00A0— задачи без\u00A0конкретного дня, которые можно перетащить в\u00A0любой день, когда придёт время.",
      "features.4.lead": "Цветовое кодирование",
      "features.4.rest":
        "\u00A0— выделите особенно важное, чтобы оно сразу бросалось в\u00A0глаза.",
